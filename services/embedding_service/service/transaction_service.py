...
class TransactionService:
    ...
    def save(self, transaction: dict):
        ...
        transaction_embedding = TransactionEmbedding(transaction_id=new_transaction.id, embedding=txn_embedding)
    ...
    def _format_transaction_text(self, transaction: Transaction) -> str:
        ...
        direction = "debited from" if transaction.transaction_type == "DEBIT" else "credited to"
